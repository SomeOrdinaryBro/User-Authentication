...
const weatherCardsDiv = document.querySelector(".days-forecast .row");

const API_KEY = "714cd6717ee23f3ad8a57a4b236735a8"; // API key for OpenWeatherMap API
...
const createWeatherCard = (cityName, weatherItem, index) => {
  if (index === 0) {
    ...
    return `<div class="col-md-4 mb-3">
                    <div class="card forecast-card bg-secondary text-white">
